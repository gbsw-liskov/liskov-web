    ...
    <div className="w-full min-h-[252px] p-[25px] mt-[20px]">
      ...
      <div className="min-h-[215px] w-full mt-[13px]">
        {advance.map((item, index) => (
          <div
            key={index}
            className="box-content min-w-full min-h-[39px] p-[12px] flex mb-[13px]"
          >
            ...
            <div className="min-w-[136px] min-h-[39px]">
              <p className="text-[15px] text-black">{item.title}</p>
              <p className="text-[13px] text-[#757575]">{item.content}</p>
            </div>
          </div>
        ))}
      </div>
